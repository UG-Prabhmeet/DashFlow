...
export default function Home() {
    return (
        <div>
            {/* Hero Section */}
            <section className="w-full min-h-screen flex custom-gradient flex-col justify-between px-6 sm:px-12 md:px-32 pb-12">
                {/* Text Content */}
                <div className="pt-32">
                    <div className="max-w-2xl">
                        <h1 className="text-5xl font-bold leading-tight text-white mb-6">
                            ...
                            <br />
                            With{" "}
                            <span className="text-orange-400">DashFlow</span>
                        </h1>
                        <p className="text-lg text-gray-200 mb-8">
                            Your all-in-one platform to manage tasks, teams, and
                            timelines with ease and efficiency.
                        </p>
                ...
                <div className="w-full max-w-6xl grid grid-cols-1 md:grid-cols-2 gap-12">
                    ...
                    <div className="flex flex-col justify-center">
                        ...
                        <p className="text-gray-500 mb-8 max-w-md">
                            To help you make informed decisions, we’ve compiled
